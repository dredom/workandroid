...
/**
 * To send a link to the device:
 * <ul>
 *  <li>login with your Google gmail account that matches account on device. </li>
 *  <li>lvlstudios-gt-message.appspot.com/signin?&extret=http://code.google.com/p/chrometophone/logo?login </li>
 *  <li>(lvlstudios-gt-message.appspot.com/signout?&extret=http://code.google.com/p/chrometophone/logo?logout) </li>
 *  <li>Obtain Sender Auth Token from Google services. </li>
 *  <li>install REST client or use curl. </li>
 *  <li>http://lvlstudios-gt-message.appspot.com/send?title=TEST&url=http://www.jenandjane.com&deviceName=untiedt.dev@gmail.com#615069a8&deviceType=ac2dm </li>
 * </ul>
 * Auth Token: https://www.google.com/accounts/ClientLogin
 * Send: POST https://android.apis.google.com/c2dm/send
 */
@SuppressWarnings("serial")
public class SendServlet extends HttpServlet {
    static final Logger log = Logger.getLogger(SendServlet.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        log.info("SendServlet.doPost: " + req.getRequestURI());
    ...
    protected String doSendToDevice(String url, String title,
        ...
        for (DeviceInfo deviceInfo : reqInfo.devices) {
            log.info(" - device: " + deviceInfo.toString());
            ...
            try {
                if (deviceInfo.getType().equals(DeviceInfo.TYPE_CHROME)) {
                    log.info("SendServlet.doSendToDevice:browser: " + deviceInfo.toString());
                    res = doSendViaBrowserChannel(url, deviceInfo);
                } else {
                    log.info("SendServlet.doSendToDevice:c2dm: " + deviceInfo.toString());
        ...
        if (ok) {
            ...
            if (ac2dmCnt == 0 && "ac2dm".equals(deviceType)) {
                ...
                log.warning(ERROR_STATUS + " (Unable to send link)");
